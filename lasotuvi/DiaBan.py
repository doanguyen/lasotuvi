...
class cungDiaBan(object):
    def __init__(self, cungID):
        ...
        hanhCung = [None, "Thủy", "Thổ", "Mộc", "Mộc", "Thổ", "Hỏa", "Hỏa", "Thổ", "Kim", "Kim",
                    "Thổ", "Thủy"]
        self.cungSo = cungID
...
class diaBan(object):
    ...
    def cungChu(self, thangSinhAmLich, gioSinhAmLich):
        ...
        cungChuThapNhiCung = [{'cungId': 1, 'tenCung': "Mệnh", 'cungSoDiaBan': self.cungMenh},
            ...
            }, {'cungId': 8, 'tenCung': "Tật Ách", 'cungSoDiaBan': self.cungTatAch
...
def dacTinhSao(viTriDiaBan, sao):
    saoId = sao.id
    maTranDacTinh = {1: ["Tử vi", "B", "Đ", "M", "B", "V", "M", "M", "Đ", "M", "B", "V", "B"],
    ...
    if sao.id in maTranDacTinh.keys():
        if maTranDacTinh[sao.id][viTriDiaBan] in ["M", "V", "Đ", "B", "H"]:
